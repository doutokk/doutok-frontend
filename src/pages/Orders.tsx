...
import { List, Card, Typography, Space, Empty, Image } from 'antd';
                    ...
                    <List.Item>
                      <div className="flex w-full flex-wrap md:flex-nowrap gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <Text type="secondary" ellipsis={{ rows: 2 }}>{orderItem.item.description}</Text>
                          <div className="mt-2 flex flex-wrap gap-4">
                            <Text>单价: {orderItem.item.price} {order.userCurrency}</Text>
                            <Text>数量: {orderItem.item.quantity}</Text>
                            <Text strong>总价: {orderItem.cost} {order.userCurrency}</Text>
                          </div>
                        </div>
                      </div>
                    </List.Item>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <div className="flex justify-end">
                    <Text strong className="text-lg">
                      订单总金额: {calculateOrderTotal(order)} {order.userCurrency}
                    </Text>
                  </div>
                </div>
              </Card>
